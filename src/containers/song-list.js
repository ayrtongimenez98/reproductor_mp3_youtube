...
class SongList extends Component {
  ...
  renderSavePlaylistBtn(){
    ...
    if (this.props.user){
      if (!this.props.items[this.props.playlistId]){
        return (
          <button className="song-list-save" onClick={this.savePlaylist}>Me gusta</button>
        )
      } else {
        return (
          <button className="song-list-save" onClick={this.removePlaylist}> Ya no me gusta</button>
        )
      }
    } else {
      return (
        ...
        <div className="song-list-container" style={background}>
          ...
          <div className="song-list-title-block">
            ...
            <div className="song-list-details">
              ...
              <span>{playlistInfo.songCount} canciones</span>
              <button className="song-list-play" onClick={this.playAll}>&#9658; Reproducir</button>
