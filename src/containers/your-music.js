    ...
    if (this.state.showList === 'playlists'){
      ...
      if (playlistItems.length > 0){
        ...
        return (
          ...
          <button onClick={() => this.props.onPageSelect('browse')}>Explorar</button>
          </div>
        )
      }
      ...
      <div className="outer-container">
        <div className="your-music-container">
          ...
          <div className="navigation">
            <button onClick={() => this.onNavClick('playlists')}>Listas de reproducción<hr className={this.selectedClass('playlists')}/></button>
            <button onClick={() => this.onNavClick('songs')}>Canciones<hr className={this.selectedClass('songs')}/></button>
          </div>
